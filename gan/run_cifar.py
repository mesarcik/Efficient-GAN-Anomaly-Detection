...
import importlib
import sys
import gan.cifar_utilities as network
...
def train_and_test(nb_epochs, weight, method, degree, random_seed, label):
    ...
    """
    logger = logging.getLogger("GAN.train.cifar.{}.{}".format(method,label))
    ...
    with sv.managed_session() as sess:
        ...
        prc_auc = do_prc(scores, testy,
               file_name=r'gan/cifar/{}/{}/{}'.format(method, weight,
                                                     label),
               directory=r'results/gan/cifar/{}/{}/'.format(method,
                                                           weight))
